...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--grid_height', type=int, default = 100)
    arg_parser.add_argument('--z_min', type=float, default = 0.5)
    arg_parser.add_argument('--z_max', type=float, default = 0.6)
    arg_parser.add_argument('--start_row', type=int, default = 4)
    arg_parser.add_argument('--start_col', type=int, default = 9)
    arg_parser.add_argument('--robot_radius', type=float, default = 0.4)
    arg_parser.add_argument('--robot_yaw', type=float, default = 45)
    arg_parser.add_argument('--robot_sensor_range', type=float, default = 9)
    arg_parser.add_argument('--robot_sensor_view_angle', type=float, default = 45)
